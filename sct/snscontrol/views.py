...
def publish_twitter(request, pk):
    ...
    if post.is_publish_twitter is True:
                    ...
                    if post.image3:
                        ...
                        if post.image4:
                            ...
                            t.post_with_media(
                                text=post.content,
                                media_ids=",".join(
                                    [id_img1, id_img2, id_img3, id_img4]
                                ),
                            )
                        else:
                            t.post_with_media(
                                text=post.content,
                                media_ids=",".join([id_img1, id_img2, id_img3]),
                            )
                    else:
                        t.post_with_media(
                            text=post.content, media_ids=",".join([id_img1, id_img2])
                        )
                else:
